...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6010375028:AAEV-wV8LR6qxeQmpWZiT9QtBtRIsrjDPXs"
else:
    tgkey = tgenv
print(tgenv)
